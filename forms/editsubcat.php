...
{
    $sid=$_GET["sid"];
    $sql=mysqli_query($conn,"SELECT * FROM tbl_subcat WHERE subid='$sid'");
...
$sql=mysqli_query($conn,"select * from tbl_cat WHERE status=0"); 
?>
...
if(isset($_POST["btnsubmit"]))
{
    ...
    $sql=mysqli_query($conn,"UPDATE tbl_subcat SET s_name='$name',catid='$cid' WHERE subid='$sid'");
    if($sql)
    {
